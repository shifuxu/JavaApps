...
//							}
	...
	//关于记事本菜单项的功能实现  
		aboutboxitem.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				JOptionPane.showMessageDialog(jf,"关于记事本...",JOptionPane.INFORMATION_MESSAGE);
			}
		});
	//关于作者菜单项的功能实现  
		writeritem.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				JOptionPane.showMessageDialog(jf,"作者：steven\n性别：男\n" +
						"本科院校: 东北林业大学" ,JOptionPane.INFORMATION_MESSAGE);
			}
		});
    //关闭程序事件
